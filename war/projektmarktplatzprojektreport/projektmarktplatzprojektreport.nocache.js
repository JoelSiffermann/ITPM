...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "projektmarktplatzprojektreport" because\n';
  ...
  $wnd.__gwt_activeModules['projektmarktplatzprojektreport'] = {
    'moduleName' : 'projektmarktplatzprojektreport',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/projektmarktplatzprojektreport.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['projektmarktplatzprojektreport'].superdevmode = true;

  var expectedSuffix = '/projektmarktplatzprojektreport.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + projektmarktplatzprojektreport + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:projektmarktplatzprojektreport';
  var devModeSessionKey = '__gwtDevModeSession:projektmarktplatzprojektreport';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/projektmarktplatzprojektreport/projektmarktplatzprojektreport.nocache.js';
  ...
  $wnd.__gwt_activeModules['projektmarktplatzprojektreport'].canRedirect = true;
  $wnd.__gwt_activeModules['projektmarktplatzprojektreport'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING projektmarktplatzprojektreport';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/projektmarktplatzprojektreport?user.agent=' + ua + '&_callback=' + callback;
