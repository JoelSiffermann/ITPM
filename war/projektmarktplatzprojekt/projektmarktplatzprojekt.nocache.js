...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "projektmarktplatzprojekt" because\n';
  ...
  $wnd.__gwt_activeModules['projektmarktplatzprojekt'] = {
    'moduleName' : 'projektmarktplatzprojekt',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/projektmarktplatzprojekt.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['projektmarktplatzprojekt'].superdevmode = true;

  var expectedSuffix = '/projektmarktplatzprojekt.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + projektmarktplatzprojekt + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:projektmarktplatzprojekt';
  var devModeSessionKey = '__gwtDevModeSession:projektmarktplatzprojekt';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/projektmarktplatzprojekt/projektmarktplatzprojekt.nocache.js';
  ...
  $wnd.__gwt_activeModules['projektmarktplatzprojekt'].canRedirect = true;
  $wnd.__gwt_activeModules['projektmarktplatzprojekt'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING projektmarktplatzprojekt';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/projektmarktplatzprojekt?user.agent=' + ua + '&_callback=' + callback;
